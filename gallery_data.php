            ...
            <tr>
                ...
                <td>
                    <?php if ($row["gambar"] != '' && file_exists('img/' . $row["gambar"])) { ?>
                        <img src="img/<?= $row['gambar'] ?>" width="130">
                    <?php } ?>
                </td>
                <td>
                    <!-- Edit -->
                    ...
                    <!-- detail -->
                    <a href="#" title="detail" class="badge rounded-pill text-bg-info" data-bs-toggle="modal"
                        data-bs-target="#modalDetail<?= $row['id'] ?>"><i class="bi bi-eye"></i></a>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <img src="img/<?= $row['gambar'] ?>" class="img-fluid" alt="Gambar">
                                    </div>
                            </div>
                        </div>
                    </div>
